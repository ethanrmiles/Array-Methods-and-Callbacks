...
function getFinals(array) {
   ...
   return allFinals //this belongs to getFinals
}

//console.log('task 2', getFinals(fifaData).length)
...
//console.log(getYears(fifaData, getFinals).length)
...
//console.log('task 4', getWinners(fifaData, getFinals).length)
